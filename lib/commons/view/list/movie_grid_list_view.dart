...
class MovieGridListView extends StatelessWidget {
  const MovieGridListView({Key? key, this.models, required this.onPressed})
      : super(key: key);
        ...
        child: Stack(
          children: [
            ClipRRect(
              ...
              child: Image.network(
                  Constant.MOVIE_IMAGES_BASE_URL + movieResponse.posterPath!,
                  fit: BoxFit.fill,
